...
import { CheckSquare, ShieldX, RefreshCw } from 'lucide-react'
        ...
        <form className="my-20 border-2 p-4 flex flex-col gap-4">
            ...
            {state1?.success && !pending1 &&
                <div className="text-sm font-medium text-green-600 bg-green-50 rounded-md flex items-center border">
                    {<CheckSquare className="inline m-4 mr-2 size-4" />} {state1.success}
                </div>
            }
            ...
            {state2?.success && !pending2 &&
                <div className="text-sm font-medium text-green-600 bg-green-50 rounded-md flex items-center border">
                    {<CheckSquare className="inline m-4 mr-2 size-4" />} {state2.success}
                </div>
            }
            ...
            {state3?.success && !pending3 &&
                <div className="text-sm font-medium text-green-600 bg-green-50 rounded-md flex items-center border">
                    {<CheckSquare className="inline m-4 mr-2 size-4" />} {state3.success}
                </div>
            }
